    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center py-12 px-4">
        ...
        >
          ...
          <div className="mt-16 flex justify-center lg:justify-end animate-fade-in-up animation-delay-1200">
            <div className="relative group">
              <img
              ...
              />
              <div className="absolute inset-0 bg-[#ee8900] rounded-lg opacity-0 group-hover:opacity-5 transition-opacity duration-300 -z-10 blur-xl"></div>
            </div>
          </div>
        </div>
      </div>
