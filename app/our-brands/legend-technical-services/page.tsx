...
import { Settings, Building, Users, Shield, CheckCircle, Zap } from "lucide-react"
                ...
                <div className="space-y-6">
                  <AnimatedText delay={400}>
                    <p className="text-lg text-gray-700 font-effra leading-relaxed">
                      Legend Technical Services is{" "}
                      <span className="font-semibold text-[#3D1A78]">world-class facilities management</span>. As part of
                      our one-stop solution concept, becoming self-sufficient in facilities is a critical step.
                    </p>
                  </AnimatedText>

                  <AnimatedText delay={600}>
                    <p className="text-lg text-gray-700 font-effra leading-relaxed">
                      Establishing <span className="font-semibold text-[#E67E22]">Legend Facility Management</span>, which
                      serves as our project control gate. In addition to its external operation as a customer-centric
                      company, Legend Facility Management offers a wide range of customized solutions for various
                      divisions.
                    </p>
                  </AnimatedText>
                  ...
                  <AnimatedText delay={800}>
                    <p className="text-lg text-gray-700 font-effra leading-relaxed">
                      Our comprehensive services span across{" "}
                      <span className="font-semibold text-[#27AE60]">
                        governmental, commercial, residential and industrial foundations
                      </span>
                      , ensuring optimal facility performance and operational excellence.
                    </p>
                  </AnimatedText>

                  <AnimatedText delay={1000}>
                    <p className="text-lg text-gray-700 font-effra leading-relaxed">
                      Through advanced technology integration and expert project management, we deliver sustainable,
                      efficient, and cost-effective facility solutions that exceed industry standards.
                    </p>
                  </AnimatedText>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-6 pt-8">
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-semibold text-gray-900 font-richmond">Governmental</span>
                      </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-semibold text-gray-900 font-richmond">Commercial</span>
                      </div>
                      <p className="text-sm text-gray-600 font-effra">Comprehensive business facility management</p>
                    </div>

                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-[#3D1A78]/10 rounded-full flex items-center justify-center">
                          <Shield className="w-4 h-4 text-[#3D1A78]" />
                        </div>
                        <span className="text-sm font-semibold text-gray-900 font-richmond">Residential</span>
                      </div>
                      <p className="text-sm text-gray-600 font-effra">Premium residential facility services</p>
                    </div>

                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-[#8E44AD]/10 rounded-full flex items-center justify-center">
                          <Settings className="w-4 h-4 text-[#8E44AD]" />
                        </div>
                        <span className="text-sm font-semibold text-gray-900 font-richmond">Industrial</span>
                      </div>
                      <p className="text-sm text-gray-600 font-effra">Advanced industrial facility solutions</p>
                    </div>
                  </div>
                </AnimatedText>
                  ...
                  <div className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-200">
                    <div className="text-center">
                      <div className="flex items-center justify-center w-12 h-12 bg-[#3D1A78]/10 rounded-full mb-3 mx-auto">
                        <Building className="w-6 h-6 text-[#3D1A78]" />
                      </div>
                      ...
                      <div className="text-sm text-gray-600 font-effra">Facilities Managed</div>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-gray-600 font-effra">Operations</div>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-gray-600 font-effra">Efficiency Rate</div>
                    </div>
                  </div>
                </AnimatedText>
              </div>
                    ...
                    <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
                      ...
                      <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-lg font-bold text-[#3D1A78] font-richmond">World-Class</div>
                            <div className="text-sm text-gray-600 font-effra">Facility Management</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                        <div className="text-center">
                          <div className="text-2xl font-bold text-[#E67E22] font-richmond">
                            <AnimatedCounter target={200} suffix="+" duration={2000} startDelay={1000} />
                          </div>
                          <div className="text-sm text-gray-600 font-effra">Facilities</div>
                        </div>
                      </div>
                      ...
                      <div className="absolute top-6 right-6 bg-[#27AE60]/90 backdrop-blur-sm rounded-lg px-3 py-2 shadow-lg">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-white font-semibold text-sm font-richmond">Project Control Gate</span>
                        </div>
                      </div>

                      {/* One-Stop Solution Badge */}
                      <div className="absolute bottom-6 left-6 bg-[#3D1A78]/90 backdrop-blur-sm rounded-lg px-3 py-2 shadow-lg">
                        <div className="text-white font-bold text-sm tracking-wider font-richmond">ONE-STOP SOLUTION</div>
                      </div>
                    </div>
                  </div>
                </AnimatedText>
